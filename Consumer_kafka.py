import sys, codecs,json,nltk,genism,spacy,textprocessing,re,psycopg2
import pandas as pd
...
def extracttweetfeatures(tweets,output):
    '''
    extracttweetfeatures function 
        Input = tweet dataframe and output list.
        Output list comprises of the list
